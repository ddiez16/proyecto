          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <button class="btn btn-primary btn-sm btn-block<?php header("location: cart.php"); ?>">Actualizar carrito</button>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p>Introduce tu cupon si tienes uno.</p>
              </div>
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='gracias.php'">Pasar por caja</button>
                  </div>
                </div>
              </div>
            </div>
